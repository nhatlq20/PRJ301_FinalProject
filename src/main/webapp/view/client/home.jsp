        ...
        <%@page contentType="text/html" pageEncoding="UTF-8" %>
            <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
                <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
                        ...
                        <%@ include file="../common/header.jsp" %>
                            <nav class="nav-categories">
                                <ul>
                                    ...
                                    <li><a href="#bestsellers" class="active" data-duration="500">Sản phẩm bán chạy
                                            nhất</a></li>
                            ...
                            <!-- ✅ ĐÃ SỬA: Thêm banner với nền Banner3.png -->
                                                        ...
                                                        <div class="bestseller-card bestseller-card-large">
                                                            <div class="card product-card h-100 border-0 shadow-sm">
                                                                ...
                                                                <div class="card-body"
                                                                    ...
                                                                    <c:choose>
                                                                        <c:when
                                                                            test="${m.sellingPrice != null && m.sellingPrice > 0}">
                                                                            ...
                                                                            <a class="btn btn-primary w-100 mt-2"
                                                                                href="${pageContext.request.contextPath}/cart?action=add&id=${m.medicineID}">Chọn
                                                                                mua</a>
                                                                        </c:when>
                                                                        <c:otherwise>
                                                                            <p class="text-muted fw-semibold mb-1">Cần
                                                                                được sự tư vấn của bác sĩ</p>
                                                                            <a class="btn btn-primary w-100 mt-2"
                                                                                href="${pageContext.request.contextPath}/product/detail?id=${m.medicineID}">Xem
                                                                                chi tiết</a>
                                                                        </c:otherwise>
                                                                    </c:choose>
                                                                </div>
                                                ...
                                                <div class="card product-card h-100 border-0 shadow-sm">
                                                    ...
                                                    <div class="card-body"
                                                        ...
                                                        <c:choose>
                                                            ...
                                                            <c:otherwise>
                                                                <p class="text-muted fw-semibold mb-1">Cần được sự tư
                                                                    vấn của bác sĩ</p>
                                                                <a class="btn btn-primary w-100 mt-2"
                                                                    href="${pageContext.request.contextPath}/product/detail?id=${m.medicineID}">Xem
                                                                    chi tiết</a>
                    ...
                    <!-- ✅ ĐÃ SỬA: Di chuyển tiêu đề ra ngoài container, xóa khối duplicate price/button -->
                    <!-- ===================================== -->
                    <section class="featured-products py-5">
                        ...
                        <!-- ✅ ĐÃ SỬA: Thêm khối content chứa các card sản phẩm -->
                                        ...
                                        <div class="card product-card h-100 border-0 shadow-sm">
                                            ...
                                            <div class="card-body"
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <p class="text-muted fw-semibold mb-1">Cần được sự tư vấn của
                                                            bác sĩ</p>
                                                        <a class="btn btn-primary w-100 mt-2"
                                                            href="${pageContext.request.contextPath}/product/detail?id=${m.medicineID}">Xem
                                                            chi tiết</a>
